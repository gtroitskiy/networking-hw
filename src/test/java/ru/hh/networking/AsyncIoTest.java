...
public class AsyncIoTest {
  ...
  public void ddosAsyncServer() throws IOException, InterruptedException {
    ...
    AsynchronousChannelGroup group = AsynchronousChannelGroup.withFixedThreadPool(
        nThreads,
        r -> new Thread(Thread.currentThread().getThreadGroup(), r, "async-worker-" + idGenerator.incrementAndGet())
    );
          ...
          client.write(buffer, buffer, new CompletionHandler<Integer, ByteBuffer>() {
            ...
            public void completed(Integer result, ByteBuffer attachment) {
              if (attachment.hasRemaining()) {
                ...
                attachment.clear();
                client.read(attachment, attachment, new CompletionHandler<Integer, ByteBuffer>() { // TODO: modify this line
                  @Override
                  public void completed(Integer result, ByteBuffer attachment) {
